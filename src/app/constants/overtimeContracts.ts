...
export const ETH_OPTIMISM = "0x4200000000000000000000000000000000000006";
export const REFERRAL_ADDRESS = "0x0527CE868B650845222f1A1Ca1c1aBF2dA8DFBAc";
export const DEFAULT_SLIPPAGE = parseEther("0.02");
...
const sportsAMMV2Contract = {
  ...
  abi: [
    ...
    },
    {
      ...
      name: "referrals",
      outputs: [
        { internalType: "contract IReferrals", name: "", type: "address" },
      ],
      stateMutability: "view",
      type: "function",
    },
    ...
    {
      inputs: [
        { internalType: "uint256", name: "_safeBoxFee", type: "uint256" },
      ],
      name: "setAmounts",
      outputs: [],
      stateMutability: "nonpayable",
    ...
    {
      inputs: [
        { internalType: "address", name: "_freeBetsHolder", type: "address" },
      ],
      name: "setFreeBetsHolder",
      outputs: [],
      stateMutability: "nonpayable",
    ...
    {
      inputs: [
        { internalType: "address", name: "_ticketMastercopy", type: "address" },
      ],
